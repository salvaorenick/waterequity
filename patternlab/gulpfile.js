...
gulp.task('styles', function(cb){
    ...
    .pipe(sass({
        ...
        .pipe(gulp.dest(config.paths.django_project.css))
    ;
});
...
gulp.task('javascript:dev', function() {
    return gulp.src([
        ...
        .pipe(gulp.dest(config.paths.django_project.js))
    ;
});
...
gulp.task('default', function(cb) {
    runSequence (
        ['bower', 'lab', 'copy:styleguide', 'copy:styleguide-css', 'copy:annotations', 'javascript:dev', 'copy:javascript'],
        'styles',
        'modernizr:dev',
        'modernizr:prepare',
        cb
